...
<nav class="navbar navbar-inverse navbar-static-top main-menu-bar" role="navigation">
    <a class="navbar-brand" href="#">Tableau Postgres-KDB Example</a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li id="id-get-data-refresh">
                    <a href="#" onclick="getUnderlyingData(true)">Get Tableau-KDB(Postgres) Data</a>
                </li>
            </ul>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">URL: <input type="text" id="url" class="form-control" value="{{tableau_url}}#/views/JS_Fast/rtDataPostgress?par1=12&:refresh=yes"/></div>
    </div>
    <div class="row">
